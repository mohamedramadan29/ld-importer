        ...
        <div class="container">
            <div class="row g-3 justify-content-center">
                <div class="col-6 col-md-3" data-aos="fade-up" data-aos-delay="0">
                    <a href="{{ route('front.category') }}" class="filter-tab-card {{ !request()->routeIs('front.category.show') ? 'active-filter' : '' }}">
                ...
                <div class="col-6 col-md-3" data-aos="fade-up" data-aos-delay="{{ ($index + 1) * 100 }}">
                    <a href="{{ route('front.category.show', $category->slug) }}" class="filter-tab-card">
                        <svg viewBox="0 0 24 24">
