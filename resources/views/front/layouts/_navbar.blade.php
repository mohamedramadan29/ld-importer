...
@endphp
        ...
        <div class="container d-flex flex-column">
            <div class="navbar-top-wrapper">
                ...
                <div class="nav-icons">
                    ...
                    <!-- Favorites Link -->
                    <a href="{{ route('front.favorites') }}" class="nav-favorite-btn ms-3">
    ...
    <div class="offcanvas offcanvas-start offcanvas-custom" tabindex="-1" id="mobileSidebar"
        aria-labelledby="mobileSidebarLabel">
        <div class="offcanvas-header justify-content-between pt-4">
            ...
            searchInput.addEventListener('input', function() {
                ...
                searchTimeout = setTimeout(function() {
                    fetch('{{ route("front.search.live") }}?q=' + encodeURIComponent(query))
                        ...
                        .then(data => {
                            if (data.length === 0) {
                                searchResults.innerHTML = '<div class="live-search-empty">No products found</div>';
                            } else {
                                let html = '';
                                ...
                                html += '<a href="{{ route("front.search") }}?q=' + encodeURIComponent(query) + '" class="live-search-view-all">View All Results →</a>';
